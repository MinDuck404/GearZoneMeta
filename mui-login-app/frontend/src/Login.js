...
function Login({ setLoggedIn, toggleRegister }) {
  ...
  const handleSubmit = (event) => {
    ...
    // setLoggedIn(true); // Uncomment nếu đăng nhập thành công
  };
      ...
      <Container maxWidth="xs">
        <Box
          ...
          sx={{
            ...
            top: '100px',                // Đẩy khung xuống dưới
            left: '50px',               // Đẩy khung sang phải
            transform: 'translate(-20%, -10%)', // Điều chỉnh thêm vị trí theo tỷ lệ
          }}
        >
